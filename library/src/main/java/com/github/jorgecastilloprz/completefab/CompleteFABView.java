...
public class CompleteFABView extends FrameLayout {
    ...
    private void setIcon() {
        iconView = (ImageView) findViewById(R.id.completeFabIcon);
    ...
    private void animate(AnimatorSet progressArcAnimator, boolean inverse) {
        ...
        ValueAnimator iconScaleAnimX = ObjectAnimator.ofFloat(iconView, "scaleX", 0, 1);
        ValueAnimator iconScaleAnimY = ObjectAnimator.ofFloat(iconView, "scaleY", 0, 1);
